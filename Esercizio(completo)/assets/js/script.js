...
<img src="${element.imageUrl}" class="card-img-top w-50 p-3" ; alt="...">
<div class="card-body">
...
<div class="card-body">
  <a href="edit.html?id=${element._id}"><button id='btn-modifica' class="btn btn-dark me-2" type="">Modifica</button></a>
  <a href="detail.html?id=${element._id}"><button id='btn-scopri' class="btn btn-light" type="">Scopri di più</button></a>
</div>
</div> `;
...
spinner.innerHTML = `<div class="spinner-border text-warning" role="status">
